...
class AuthenticationRoute extends Route {
	...
	render() {
		return this.isValidRouting() ? super.render() : <Redirect to={this.props.redirectOnFailure} />;
	}
}
...
export default compose(withRouter, connect(mapStateToProps))(AuthenticationRoute);
